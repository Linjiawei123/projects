...
{
    public static class RedisHepler
    {
        static ConnectionMultiplexer redis = null;
        /// <summary>
        /// 数据库访问对象
        /// </summary>
        static IDatabase _db = null;
        /// <summary>
        /// 初始化
        /// </summary>
        ...
        public static void InitConnect(IConfiguration Configuration)
        {
            try
            {
                string RedisConnection = Configuration.GetValue<string>("RedisConnectionString");
        ...
        /// <returns></returns>
        public static bool StringSet(string redisKey, string redisValue, TimeSpan? expried = null)
        {
        ...
        /// <returns></returns>
        public static bool StringSet<T>(string redisKey, T redisValue, TimeSpan? expired = null)
        {
        ...
        /// <param name="redisKey"></param>
        /// <returns></returns>
        public static T StringSet<T>(string redisKey)
        {
        ...
        /// <param name="expired"></param>
        /// <returns></returns>
        public static async Task<bool> StringSetAsync(string redisKey, string redisValue, TimeSpan? expired = null)
        {
        ...
        /// <param name="expired"></param>
        /// <returns></returns>
        public static async Task<bool> StringSetAsync<T>(string redisKey, string redisValue, TimeSpan? expired = null)
        {
            string json = JsonConvert.SerializeObject(redisValue);
        ...
        /// <param name="redisKey"></param>
        /// <returns></returns>
        public static async Task<T> StringGetAsync<T>(string redisKey)
        {
        ...
        /// <returns></returns>
        public static bool HashExist(string redisKey, string hashField)
        {
        ...
        /// <param name="hashField"></param>
        /// <returns></returns>
        public static async Task<IEnumerable<RedisValue>> HashGetAsync(string redisKey, RedisValue[] hashField)
        {
            return await _db.HashGetAsync(redisKey, hashField);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static bool AddList<T>(string listkey, List<T> list)
        {
            if (_db == null)
            {
                return false;
        ...
        /// <param name="listkey">Key</param>
        /// <returns></returns>
        public static List<T> GetList<T>(string listkey)
        {
            if (_db == null)
            {
                return new List<T>();
        ...
        /// <returns></returns>
        public static bool DelListByLambda<T>(string listkey, Func<T, bool> func)
        {
            if (_db == null)
                return false;
            if (_db.KeyExists(listkey))
        ...
        /// <param name="func">lamdba表达式</param>
        /// <returns></returns>
        public static List<T> GetListByLambda<T>(string listkey, Func<T, bool> func)
        {
            if (_db == null)
                return new List<T>();
            if (_db.KeyExists(listkey))
        ...
        /// <param name="redisValue"></param>
        /// <returns></returns>
        public static async Task<long> ListRightPushAsync<T>(string redisKey, string redisValue)
        {
        ...
        /// <param name="redisValue"></param>
        /// <returns></returns>
        public static async Task<long> ListLeftPushAsync<T>(string redisKey, string redisValue)
        {
        ...
        /// <param name="member"></param>
        /// <returns></returns>
        public static bool SortedSetLength(string redisKey, string member)
        {
        ...
        /// <param name="member"></param>
        /// <returns></returns>
        public static async Task<bool> SortedSetRemoveAsync(string redisKey, string member)
        {
        ...
        /// <returns></returns>
        public static bool KeyReName(string oldKeyName, string newKeyName)
        {
        ...
        /// <param name="expired"></param>
        /// <returns></returns>
        public static bool KeyExpire(string redisKey, TimeSpan? expired = null)
        {
        ...
        /// <param name="expired"></param>
        /// <returns></returns>
        public static async Task<bool> KeyExpireAsync(string redisKey, TimeSpan? expired)
        {
