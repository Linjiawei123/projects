<template>
    <div class="box">
        <div class="search">
            ...
            <el-select class="search-input" v-model="this.searchParams.InvenTypeCode" placeholder="货存分类" clearable>
                <el-option v-for="item in types" :key="item.invenTypeCode" :label="item.invenTypeName"
                    :value="item.invenTypeCode" />
            </el-select>
            <el-input class="search-input" v-model="this.searchParams.SpecsModel" placeholder="规格型号" clearable />
            <el-input class="search-input" v-model="this.searchParams.MeaUnit" placeholder="计量单位" clearable />
            <el-input class="search-input" v-model="this.searchParams.SelPrice" placeholder="参考售价" clearable />
            <el-input class="search-input" v-model="this.searchParams.PurPrice" placeholder="参考进价" clearable />
            <el-input class="search-input" v-model="this.searchParams.SmallStockNum" placeholder="最低库存" clearable />
            <el-input class="search-input" v-model="this.searchParams.BigStockNum" placeholder="最高库存" clearable />
        ...
        <el-drawer v-model="drawerVisible" :with-header="false" :show-close="false" size="40%">
            ...
            <el-form ref="form" :model="form" :rules="rules">
                ...
                <el-form-item label="存货分类：" prop="invenTypeCode">
                    <el-select v-model="form.invenTypeCode" class="m-2" placeholder="选择分类">
                        <el-option v-for="item in types" :key="item.invenTypeCode" :label="item.invenTypeName"
                            :value="item.invenTypeCode" />
                    </el-select>
                </el-form-item>
...
export default {
    ...
    methods: {
        getList() {
            ...
            if (this.searchParams.InvenTypeCode != '') formData.append("InvenTypeCode", this.searchParams.InvenTypeCode);
            if (this.searchParams.SpecsModel != '') formData.append("SpecsModel", this.searchParams.SpecsModel);
            if (this.searchParams.MeaUnit != '') formData.append("MeaUnit", this.searchParams.MeaUnit);
            if (this.searchParams.SelPrice > 0) formData.append("SelPrice", this.searchParams.SelPrice);
            if (this.searchParams.PurPrice > 0) formData.append("PurPrice", this.searchParams.PurPrice);
            if (this.searchParams.SmallStockNum > 0) formData.append("SmallStockNum", this.searchParams.SmallStockNum);
            if (this.searchParams.BigStockNum > 0) formData.append("BigStockNum", this.searchParams.BigStockNum);
