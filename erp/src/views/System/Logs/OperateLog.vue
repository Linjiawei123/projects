    ...
    <div class="box">
        ...
        <div class="tableBox">
            <el-table class="table" :data="page.pageData" row-key="id"
                ...
                <el-table-column label="用户昵称" min-width="10%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                ...
                <el-table-column label="操作模块" min-width="10%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                ...
                <el-table-column label="操作类型" min-width="10%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                ...
                <el-table-column label="请求方法" min-width="10%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                ...
                <el-table-column label="请求地址" min-width="40%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                ...
                <el-table-column label="操作时间" min-width="10%">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                            <span>{{ getTimeStr(scope.row.operateTime) }}</span>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        getList() {
            ...
            axios.post(path.baseUrl + path.logs + '/OperateLog/' + this.searchParams.pageSize + '/' + this.searchParams.pageIndex, formData)
                .then(res => {
