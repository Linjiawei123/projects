        ...
        <div class="tableBox">
            <el-table class="table" :data="page.pageData" row-key="id"
                ...
                <el-table-column label="业务员">
                    <template #default="scope">
                        <div style="display: flex; align-items: center">
                            <span>{{ getTypeStr(5, scope.row.employeeCode) }}</span>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-row>
                    <el-col :span="10">
                        <el-form-item label="业务员：" prop="employeeCode">
                            <el-select v-model="form.employeeCode" placeholder="选择等级" :style="{ width: '100%' }">
                                <el-option v-for="item in types.employees" :key="item.employeeCode"
                                    :label="item.employeeName" :value="item.employeeCode" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="10">
                ...
                <el-row>
                    <el-col :span="10">
                        <el-form-item label="客户等级：" prop="gradeCode">
                            <el-select v-model="form.gradeCode" placeholder="选择等级" :style="{ width: '100%' }">
                    ...
                    <el-col :span="10">
                        <el-form-item label="客户状态：" prop="stateCode">
                            <el-select v-model="form.stateCode" placeholder="选择等级" :style="{ width: '100%' }">
                ...
                <el-row>
                    <el-col :span="10">
                        <el-form-item label="信用等级：" prop="creditCode">
                            <el-select v-model="form.creditCode" placeholder="选择等级" :style="{ width: '100%' }">
                    ...
                    <el-col :span="10">
                        <el-form-item label="行业分类：" prop="tradeCode">
                            <el-select v-model="form.tradeCode" placeholder="选择等级" :style="{ width: '100%' }">
        ...
        getTypeStr(type, code) {
            if (code && this.types) {
                switch (type) {
                    ...
                    case 5:
                        return this.types.employees?.find(w => w.employeeCode === code).employeeName;
                    default:
                        return '';
                }
            } else
